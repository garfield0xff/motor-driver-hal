...
//! 
//! This example demonstrates how to control motor direction by using
//! positive and negative speed values. Shows forward/backward movement
//! and direction status monitoring.
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    motor.set_speed(400)?;
    let _direction = motor.get_direction()?;
