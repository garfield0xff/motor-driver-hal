...
//! 
//! This example demonstrates variable speed control capabilities.
//! Shows how to set different speed levels and perform gradual
//! speed changes for smooth motor operation.
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for speed in (0..=1000).step_by(100).rev() {
